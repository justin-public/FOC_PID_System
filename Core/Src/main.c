...
/* USER CODE BEGIN PD */
// IN240 Parameter
#define INA240_GAIN 20.0f           // INA240 게인
#define ADC_RESOLUTION 4096.0f      // 12-bit ADC
#define VREF 3.3f                   // 기준 전압
#define ADC_OFFSET 2048             // ADC 중점값 (12-bit 기준)

// Current Sensor ADC Channels
#define CURRENT_A_CHANNEL ADC_CHANNEL_4  // PF6 - ADC3_IN4
#define CURRENT_B_CHANNEL ADC_CHANNEL_5  // PF7 - ADC3_IN5
/* USER CODE END PD */
